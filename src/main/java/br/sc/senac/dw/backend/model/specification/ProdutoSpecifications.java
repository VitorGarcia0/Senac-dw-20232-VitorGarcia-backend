 ...
 * * root: é uma referência à entidade raiz que você está consultando. 
     ...
     * 
     * cb (CriteriaBuilder): é uma interface que oferece métodos para construção de cláusulas de consulta de
     *  forma programática. Você usa métodos deste objeto para criar expressões de predicado, funções agregadas e 
     *  outras partes da consulta.
 */
